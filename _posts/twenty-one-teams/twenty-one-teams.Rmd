...
description: |
  In this year's PremPredict, there are twenty teams, twenty-one players and a massive £105 up for grabs. Unfortunately, though, the noisy boys are currently on top: Yes, the old man, the brother and the best man. Please make it change!
  In this post, I'll also show our collective expectations for the season.
output:
...
```{r thecode201a, echo=FALSE, layout="l-body"}
knitr::kable(results)
```
...
```{r showthecode201a, ref.label='thecode201a', echo=TRUE, eval=FALSE}
```
