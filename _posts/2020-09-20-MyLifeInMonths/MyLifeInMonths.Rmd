...
This work is inspired by (and benefits from) similar analysis by [Sharla Gelfand](https://github.com/sharlagelfand/mylifeinmonths) and [Isabella Benabaye](https://isabella-b.com/blog/my-life-in-months/). As Isabella says, this type of chart can really provide perspective, which is especially helpful in difficult times. 
...
## Code for the chart {.appendix}

```{r code, ref.label='code', echo=TRUE, eval=FALSE}
```
