...
preview: europe.gif
description: |
  Previous analysis in this area has tended not to show maps over time against the right measures. I aim to do so here for Europe. The picture that emerges is generally one of sobering consistency.
output:
