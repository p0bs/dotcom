---
title: "Relaxing by the Poole"
author: "Robin Penfold"
date: "2018-01-27"
type: "post"
showonlyimage: false
draft: true
slug: "all-to-play-for"
image: "img/portfolio/PPlogo.jpg"
description: "But there's still all to play for"
weight: 2
output:
  blogdown::html_page:
    highlight: pygments
...
![](/PremPredict/homer.gif)

</br>

And this is Jon Poole right now -- at least, that's how he's feeling. Take a bow!
  
As you can tell, though, things are moving fast. So fast, in fact, that the former bottom two now occupy the top seven. (Well done, **Vera**.)
  
Here are the latest standings:

```{r thecode182, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, error=TRUE}
library(tidyverse)
library(htmlwidgets)
library(widgetframe)
library(DT)
