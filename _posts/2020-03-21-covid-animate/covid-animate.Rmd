...
preview: europe.gif
description: |
  Previous analysis in this area has tended not to show maps over time against the right measures. I aim to do so here.
output:
...
data_rebased_country_wide %>% 
  ...
  facet_wrap(~DateNumber_rebased, ncol = 4)
```
