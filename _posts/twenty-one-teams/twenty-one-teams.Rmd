...
Rather than create new posts every few months, I thought that you'd appreciate a page that updated with the latest results every time that you hit refresh.
...
For completeness (and reproducibility), here's the code that I used to calculate what's above. Note that the app does things a little different, but this standalone code should give you the gist of the approach.
