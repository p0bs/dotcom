...
preview: PPlogo.jpg
description: |
  Welcome to this year's PremPredict, where there are twenty teams, twenty-one players and a massive £105 up for grabs. But what's worse is that the noisy boys are on top: Yes, the old man, the brother and the best man. Please make it change!
...
```{r collExp20, echo=FALSE, error=TRUE, layout="l-body-outset"}
