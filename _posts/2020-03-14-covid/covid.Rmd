...
data_tidy %>% 
  ...
  labs(
    ...
    subtitle = "For the countries with the most cases \n \n"
  )
```
</br>

Whilst this chart is in a log scale, there is no sense of the country's population. 
...
```{r rebased, ref.label='collExp20', echo=TRUE, eval=FALSE}
```
